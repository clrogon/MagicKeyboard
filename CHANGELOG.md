...
## [1.4.1] - 2026-03-05 (A Correção macOS | The macOS Fix)

### Corrigido (Fixed)
-   **Compatibilidade macOS/iOS**: Resolvido um problema onde a acentuação (Dead Keys, ex: Option+E para `´`) era contada como erro antes de o utilizador terminar a letra (ex: `é`). O sistema agora respeita eventos de Composição (IME) nativos do navegador.
